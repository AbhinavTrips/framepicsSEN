...
if(loggedin()){
	if(isset($_GET['first'])&&isset($_GET['last'])&&isset($_GET['email'])&&isset($_GET['mobile'])&&isset($_GET['add1'])&&isset($_GET['add2'])&&isset($_GET['pin'])){
	...
	$new_add = "INSERT INTO `address`(`userid`, `firstname`, `lastname`, `mobile`, `address1`, `address2`, `city`, `state`, `pin`, `def`) VALUES ('$first','$last','$add1','$add2','$pin','$email','$mobile','0')";
